...
var $author$project$Main$GotTime = F2(
	function (a, b) {
		return {$: 1, a: a, b: b};
	});
...
var $author$project$Main$allGifts = $elm$core$Dict$fromList(
	A2(
		...
		$elm$core$String$toList('Video_fra_vårt_bryllup🥳❤️')));
...
var $author$project$Main$viewGiftSlot = F4(
	function (number, open, gift, onToggle) {
		var dynamicClass = open ? $elm$html$Html$Attributes$class('text-red-500 bg-white border-red-700') : $elm$html$Html$Attributes$class('text-white bg-red-500 border-transparent');
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
...
var $author$project$Main$viewHeader = A2(
	...
	_List_fromArray(
		[
			$elm$html$Html$Attributes$class('w-full sm:h-[16vmin] text-center underline')
		]),
	_List_fromArray(
		[
...
var $author$project$Main$view = function (_v0) {
	...
	return A2(
		...
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('flex flex-wrap gap-[8vw] sm:gap-[2vmin]'),
