...
*/
  ...
  function _VirtualDom_noJavaScriptOrHtmlJson(value) {
    return (typeof _Json_unwrap(value) === "string" &&
      ...
      (Array.isArray(_Json_unwrap(value)) &&
        _VirtualDom_RE_js_html.test(String(_Json_unwrap(value))))
      ? _Json_wrap(
          /**/ "", //*//**_UNUSED/'javascript:alert("This is an XSS vector. Please use ports or web components instead.")'//*/
        )
      : value;
  ...
  var $author$project$Main$GotTime = F2(function (a, b) {
    return { $: 1, a: a, b: b };
  });
  ...
  var $author$project$Main$initDay = F2(function (zone, time) {
    var month = A2($elm$time$Time$toMonth, zone, time);
    if (month === 11) {
      var day = A2($elm$time$Time$toDay, zone, time);
      return day > 23
        ? $author$project$Main$Christmas
        : $author$project$Main$Advent(day);
    } else {
    ...
    switch (msg.$) {
      case 0:
        ...
        return _Utils_Tuple2(
          ...
          A2(
            $elm$core$Task$perform,
            $author$project$Main$GotTime(zone),
            $elm$time$Time$now,
          ),
        );
      case 1:
        ...
        return _Utils_Tuple2(
          _Utils_update(model, {
            F: A2($author$project$Main$initDay, zone, time),
          }),
          $elm$core$Platform$Cmd$none,
        );
      default:
        var num = msg.a;
        var transform = A2($elm$core$Set$member, num, model.w)
          ? $elm$core$Set$remove
          : $elm$core$Set$insert;
        return _Utils_Tuple2(
          _Utils_update(model, {
  ...
  var $author$project$Main$allGifts = $elm$core$Dict$fromList(
    A2(
      ...
      $elm$core$String$toList("That_nice_dress_you_like"),
    ),
  );
    ...
    switch (day.$) {
      ...
      case 0:
        ...
        return A2(
          $elm$core$Dict$map,
          F2(function (d, gift) {
            return _Utils_cmp(today, d) > -1
              ? $author$project$Main$Available(gift)
  ...
  var $author$project$Main$viewDay = function (day) {
    return A2(
      $elm$html$Html$div,
      _List_fromArray([
        $elm$html$Html$Attributes$class("w-2/3 sm:w-[52vmin] sm:h-[16vmin]"),
        $elm$html$Html$Attributes$class("flex items-center justify-center"),
        $elm$html$Html$Attributes$class("bg-green-300"),
        $elm$html$Html$Attributes$class("rounded-xl"),
        $elm$html$Html$Attributes$class("text-center"),
        $elm$html$Html$Attributes$class("text-[0.5em]"),
      ]),
      _List_fromArray([
        $elm$html$Html$text(
          (function () {
    ...
    switch (gift.$) {
      case 0:
        ...
        return A2(
          ...
          _List_Nil,
          _List_fromArray([
            $elm$html$Html$text($elm$core$String$fromChar(content)),
          ]),
        );
      case 1:
        return A2(
          $elm$html$Html$span,
          _List_fromArray([$elm$html$Html$Attributes$class("opacity-30")]),
  ...
  var $author$project$Main$viewGiftSlot = F4(
    function (number, open, gift, onToggle) {
      var dynamicClass = open
        ? $elm$html$Html$Attributes$class(
            "text-red-500 bg-white border-red-700",
          )
        : $elm$html$Html$Attributes$class(
      ...
      return A2(
        ...
        _List_fromArray([
          ...
          $elm$html$Html$Attributes$class("h-[24vh] w-1/3 sm:size-[16vmin]"),
          $elm$html$Html$Attributes$class("rounded-xl"),
          $elm$html$Html$Attributes$class("select-none"),
          $elm$html$Html$Attributes$class("cursor-pointer"),
          $elm$html$Html$Attributes$class("border-dashed border-4"),
        ...
        open
          ? _List_fromArray([$author$project$Main$viewGiftContent(gift)])
          : _List_fromArray([
              $elm$html$Html$text($elm$core$String$fromInt(number)),
            ]),
      );
    },
  );
  var $author$project$Main$viewHeader = A2(
    ...
    _List_fromArray([
      $elm$html$Html$Attributes$class(
        "w-full sm:h-[16vmin] text-center underline",
      ),
    ]),
    _List_fromArray([$elm$html$Html$text("Advent 2025")]),
  );
  ...
  var $author$project$Main$view = function (_v0) {
    ...
    return A2(
      ...
      _List_fromArray([
        $elm$html$Html$Attributes$class(
          "flex flex-wrap gap-[8vw] sm:gap-[2vmin]",
        ),
        $elm$html$Html$Attributes$class("justify-center items-center"),
        $elm$html$Html$Attributes$class("min-w-[100vw] min-h-[100vh]"),
        $elm$html$Html$Attributes$class("p-[4vmin]"),
        $elm$html$Html$Attributes$class("text-[16vw] sm:text-[8vmin]"),
        $elm$html$Html$Attributes$class("font-mono font-bold"),
        $elm$html$Html$Attributes$class("bg-sky-300"),
