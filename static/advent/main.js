...
var $author$project$Main$viewDay = function (day) {
	return A2(
		...
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('w-3/4 sm:w-[88vmin] sm:h-[16vmin]'),
				$elm$html$Html$Attributes$class('flex items-center justify-center'),
				$elm$html$Html$Attributes$class('bg-[#D23B3B] text-white'),
...
var $author$project$Main$viewHeader = A2(
	...
	_List_fromArray(
		[
			$elm$html$Html$Attributes$class('w-full sm:h-[16vmin] text-center text-white')
		]),
	_List_fromArray(
		[
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				$elm$html$Html$Attributes$class('bg-[#753D92]'),
